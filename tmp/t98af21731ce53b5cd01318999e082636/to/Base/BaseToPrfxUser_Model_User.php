 ...
 */
abstract class BaseToPrfxUser_Model_User extends FansubCMS_Doctrine_Record
{
    ...
    {
        parent::setUp();
        $this->hasMany('ToPrfxUser_Model_Role as User_Model_Role', array(
             'local' => 'id',
